...
docker run -v "${PWD}/compile-tarball/spikedata:/releases" --platform=linux/amd64 -it --rm "${TAG}" /bin/compile-tarball --output-directory=/releases /releases/bpm-1.2.11.tgz